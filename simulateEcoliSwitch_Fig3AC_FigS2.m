...
plot(fluxes_sim_ecoli(2,:),fluxes_sim_ecoli(3,:),'-','LineWidth',0.75,'Color','k');

set(gca,'FontSize',12,'FontName','Helvetica');
xlabel('Glucose uptake (mmol/gCDW/h)','FontSize',14,'FontName','Helvetica');
ylabel(['Acetate production',char(13,10)','(mmol/gCDW/h)'],'FontSize',14,'FontName','Helvetica');
...
hold on;
box on;
plot(fluxes_exp_ecoli(1,:),fluxes_exp_ecoli(2,:),'o','LineWidth',0.75,'Color',[55,126,184]/255,'MarkerSize',8);
plot(fluxes_exp_ecoli(1,:),fluxes_exp_ecoli(3,:),'o','LineWidth',0.75,'Color',[228,26,28]/255,'MarkerSize',8);
plot(fluxes_exp_ecoli(1,:),fluxes_exp_ecoli(4,:),'o','LineWidth',0.75,'Color',[77,175,74]/255,'MarkerSize',8);
plot(fluxes_sim_ecoli(1,:),fluxes_sim_ecoli(2,:),'-','LineWidth',0.75,'Color',[55,126,184]/255);
plot(fluxes_sim_ecoli(1,:),fluxes_sim_ecoli(3,:),'-','LineWidth',0.75,'Color',[228,26,28]/255);
plot(fluxes_sim_ecoli(1,:),fluxes_sim_ecoli(4,:),'-','LineWidth',0.75,'Color',[77,175,74]/255);
