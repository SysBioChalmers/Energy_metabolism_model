...
text(0.15,43,corr_coef,'FontSize',13,'FontName','Helvetica','Color','k');
...
R = corrcoef(x,y);
corr_coef = ['R^2 = ',num2str(round(R(1,2)^2,3))];
text(0.13,0.16,corr_coef,'FontSize',13,'FontName','Helvetica','Color','k');
...
R = corrcoef(x,y);
corr_coef = ['R^2 = ',num2str(round(R(1,2)^2,3))];
text(0.12,50,corr_coef,'FontSize',13,'FontName','Helvetica','Color','k');
