...
yyaxis right;
plot(c,res(2,:),'ko','LineWidth',1,'MarkerSize',5);
set(gca,'ycolor','k');
ylim([0.66 1.04]);
...
legend({'High-yield flux',...
        'Low-yield flux',...
        'Biomass flux',...
        'Growth rate'},'FontSize',12,'FontName','Helvetica','location','nw');
...
text(0.65,0.13,corr_coef,'FontSize',14,'FontName','Helvetica','Color','k');
...
R = corrcoef(x,y);
corr_coef = ['R^2 = ',num2str(round(R(1,2)^2,3))];
text(0.65,100,corr_coef,'FontSize',14,'FontName','Helvetica','Color','k');
...
corr_coef = ['R^2 = ',num2str(round(R(1,2)^2,3))];
text(0.14,75,corr_coef,'FontSize',14,'FontName','Helvetica','Color','k');
